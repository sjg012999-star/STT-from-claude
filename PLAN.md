...
- [x] Knowledge Pack 확장 3차: Crossref/OpenAlex/Semantic Scholar metadata 조회 + open PDF cache (`--lookup-references`)
...
- [ ] 레퍼런스 논문 조회 고도화 2차 (live broad web search adapter, publisher fallback 확대, 사람 검수 UX)
