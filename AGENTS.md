...
- Use the Platform API key for `gpt-transcribe` STT only by default. Keep `gpt-4o` as an explicit legacy fallback, and keep meeting diarization on `gpt-4o-transcribe-diarize`.
